...
from wtforms import StringField, TextAreaField, DateField, TextAreaField, IntegerField
...
class UploadNoCoImageForm(FlaskForm):
    ...
    emissivity = TextAreaField('辐射系数')
    wind_speed = TextAreaField('风速')
    test_distance = TextAreaField('测试距离')
    max_temp = TextAreaField('最高温度')
    min_temp = TextAreaField('最低温度')
    env_temp = TextAreaField('环境温度')
    env_humi = TextAreaField('环境湿度')
...
class UploadCoImageForm(FlaskForm):
    ...
    high_tm1 = TextAreaField('兴趣区域1最高温度')
    high_tm2 = TextAreaField('兴趣区域2最高温度')
    high_tm3 = TextAreaField('兴趣区域3最高温度')
    high_tm4 = TextAreaField('兴趣区域4最高温度')
    high_tm5 = TextAreaField('兴趣区域5最高温度')
    low_tm1 = TextAreaField('兴趣区域1最低温度')
    low_tm2 = TextAreaField('兴趣区域2最低温度')
    low_tm3 = TextAreaField('兴趣区域3最低温度')
    low_tm4 = TextAreaField('兴趣区域4最低温度')
    low_tm5 = TextAreaField('兴趣区域5最低温度')
    re_tm1 = TextAreaField('兴趣区域1平均温度')
    re_tm2 = TextAreaField('兴趣区域2平均温度')
    re_tm3 = TextAreaField('兴趣区域3平均温度')
    re_tm4 = TextAreaField('兴趣区域4平均温度')
    re_tm5 = TextAreaField('兴趣区域5平均温度')
    rtd = TextAreaField('相对温差')
    td = TextAreaField('温差')


class UploadReCoImageForm(FlaskForm):
    """
    上传重新诊断后图片的表单
    """

    ID = IntegerField('重新诊断前的图像ID')
    co_image = FileField('重新诊断后图', validators=[FileAllowed(co_images, '只能上传图片！'), FileRequired('尚未选取图片！')])
    power_company_province = StringField('省级供电公司')
...
class UploadNoCoToCoImageForm(FlaskForm):
    """
    上传未诊断图片在线诊断后图片的表单
    """
