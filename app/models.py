...
class NoCoImage(db.Model):
    ...
    rated_current = db.Column(db.Text)
    load_current = db.Column(db.Text)
    voltage_level = db.Column(db.Text)
    weather = db.Column(db.String(20))
    emissivity = db.Column(db.Text)
    wind_speed = db.Column(db.Text)
    test_distance = db.Column(db.Text)
    max_temp = db.Column(db.Text)
    min_temp = db.Column(db.Text)
    env_temp = db.Column(db.Text)
    env_humi = db.Column(db.Text)
...
class CoImage(db.Model):
    ...
    im_h_tm = db.Column(db.Text)
    im_l_tm = db.Column(db.Text)
    TATM = db.Column(db.Text)
    RH = db.Column(db.Text)
    device_name = db.Column(db.String(50))
    device_type = db.Column(db.String(20))
    interval_name = db.Column(db.String(50))
    test_unit = db.Column(db.String(50))
