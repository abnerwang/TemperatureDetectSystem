...
class CoImage(db.Model):
    ...
    high_tm1 = db.Column(db.Float)
    high_tm2 = db.Column(db.Float)
    high_tm3 = db.Column(db.Float)
    high_tm4 = db.Column(db.Float)
    high_tm5 = db.Column(db.Float)
    low_tm1 = db.Column(db.Float)
    low_tm2 = db.Column(db.Float)
    low_tm3 = db.Column(db.Float)
    low_tm4 = db.Column(db.Float)
    low_tm5 = db.Column(db.Float)
    re_tm1 = db.Column(db.Float)
    re_tm2 = db.Column(db.Float)
    re_tm3 = db.Column(db.Float)
    re_tm4 = db.Column(db.Float)
