...
from wtforms import IntegerField, StringField, TextAreaField, DateField, TextAreaField
...
class ChangeCoImageForm(FlaskForm):
    ...
    rated_current = TextAreaField('额定电流')
    load_current = TextAreaField('负荷电流')
    voltage_level = TextAreaField('电压等级')
    weather = StringField('天气')
    E = TextAreaField('辐射系数')
    wind_speed = TextAreaField('风速')
    DST = TextAreaField('测试距离')
    TATM = TextAreaField('环境温度')
    RH = TextAreaField('环境湿度')
...
class ChangeNoCoImageForm(FlaskForm):
    ...
    wind_speed = TextAreaField('风速')
    DST = TextAreaField('测试距离')
    im_h_tm = TextAreaField('最高温度')
    im_l_tm = TextAreaField('最低温度')
    TATM = TextAreaField('环境温度')
    RH = TextAreaField('环境湿度')
    device_name = StringField('设备名称')
    device_type = StringField('设备类型')
